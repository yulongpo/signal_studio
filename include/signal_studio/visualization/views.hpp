...
[[nodiscard]] inline std::string_view to_string(ColorScale scale) noexcept {
  switch (scale) {
    case ColorScale::viridis: return "viridis";
    case ColorScale::magma: return "magma";
    case ColorScale::turbo: return "turbo";
    case ColorScale::grayscale: return "grayscale";
    case ColorScale::inferno: return "inferno";
  }
  return "unknown";
}
...
class TimeNavigator final {
 public:
  ...
  [[nodiscard]] const TimeViewport& viewport() const noexcept { return viewport_; }
  [[nodiscard]] TimeViewport& viewport() noexcept { return viewport_; }
