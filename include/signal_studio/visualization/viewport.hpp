...
class ViewportRange final {
 public:
  ...
  [[nodiscard]] double span() const noexcept { return maximum_ - minimum_; }
  ...
  void reset() { lo_ = minimum_; hi_ = maximum_; notify(); }

  [[nodiscard]] double window_lo() const noexcept { return lo_; }
  [[nodiscard]] double window_hi() const noexcept { return hi_; }
...
class FrequencyViewport final {
 public:
  ...
  [[nodiscard]] const ViewportRange& range() const noexcept { return range_; }
  [[nodiscard]] ViewportRange& range() noexcept { return range_; }
...
class TimeViewport final {
 public:
  ...
  [[nodiscard]] const LoadedDataRange& loaded() const noexcept { return loaded_; }
  [[nodiscard]] const ViewportRange& range() const noexcept { return range_; }
  [[nodiscard]] ViewportRange& range() noexcept { return range_; }
...
class ViewportController final {
 public:
  ...
  [[nodiscard]] TimeViewport& time() noexcept { return time_; }
  [[nodiscard]] FrequencyViewport& frequency() noexcept { return frequency_; }
  [[nodiscard]] const TimeViewport& time() const noexcept { return time_; }
  [[nodiscard]] const FrequencyViewport& frequency() const noexcept { return frequency_; }
