...
const core::ModuleDescriptor& module_descriptor() noexcept {
  static constexpr std::array dependencies{core::ModuleId::data, core::ModuleId::compute, core::ModuleId::task_runtime,
                                           core::ModuleId::core};
  ...
  static constexpr core::ModuleDescriptor descriptor{core::ModuleId::model_runtime,
