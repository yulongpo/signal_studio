...
std::string_view module_id_name(ModuleId id) noexcept {
  switch (id) {
    ...
    case ModuleId::compute: return "Compute";
    case ModuleId::data: return "Data";
    case ModuleId::task_runtime: return "TaskRuntime";
    case ModuleId::dsp: return "DSP";
    case ModuleId::visualization: return "Visualization";
    case ModuleId::model_runtime: return "ModelRuntime";
    case ModuleId::dataset: return "Dataset";
    case ModuleId::plugin_sdk: return "PluginSDK";
    case ModuleId::workbench: return "Workbench";
  }
  return "Unknown";
}
